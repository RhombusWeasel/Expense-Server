...
function load_game()
  ...
  engine.debug_text("Spacer1", "")
  engine.debug_text("Connections", "None")
  engine.debug_text("Last IP", 0)
  engine.debug_text("Last Port", 0)
  engine.debug_text("Last Packet", 0)
  engine.debug_text("Last Message", 0)
  engine.debug_text("Last Disconnect", 0)
  engine.debug_text("Spacer2", "")
