...
function state.startup()
  ...
  game.ecs:add_system("asteroid")
  game.ecs:add_system("orbiter")
  game.ecs:add_system("planet")
  game.ecs:add_system("collide")
  game.ecs:add_system("damage")
  game.ecs:add_system("travel")
  game.ecs:add_system("trade_ai")
  game.ecs:add_system("crafting")
  game.ecs:add_system("track")
